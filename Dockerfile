...
RUN rpm -Uvh http://mirrors.hosting.in.th/atomic/centos/7/x86_64/RPMS/clamav-0.100.2-5671.el7.art.x86_64.rpm http://mirrors.hosting.in.th/atomic/centos/7/x86_64/RPMS/clamav-db-0.100.2-5671.el7.art.x86_64.rpm http://mirrors.hosting.in.th/atomic/centos/7/x86_64/RPMS/clamav-devel-0.100.2-5671.el7.art.x86_64.rpm http://springdale.math.ias.edu/data/puias/unsupported/7/x86_64/clamav-update-0.100.2-2.sdl7.x86_64.rpm
...
# install libreoffice
RUN cd /tmp && wget https://download.documentfoundation.org/libreoffice/stable/6.4.0/rpm/x86_64/LibreOffice_6.4.0_Linux_x86-64_rpm.tar.gz
RUN cd /tmp && tar xzfv LibreOffice_6.4.0_Linux_x86-64_rpm.tar.gz && cd /tmp/LibreOffice_6.4.0.3_Linux_x86-64_rpm/RPMS && yum -y localinstall *.rpm
RUN ln -s /opt/libreoffice6.4/program/soffice /usr/local/bin/soffice
RUN rm -fr /tmp/LibreOffice_6.4.0.3_Linux_x86-64_rpm && rm /tmp/LibreOffice_6.4.0_Linux_x86-64_rpm.tar.gz
