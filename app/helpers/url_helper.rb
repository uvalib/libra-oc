...
module UrlHelper
  ...
  def orcid_oauth_button
    ...
    button_html = link_to "#{ENV['ORCID_BASE_URL']}/oauth/authorize?client_id=#{orcid_client_id}&response_type=code&scope=/authenticate /activities/update&redirect_uri=#{redirect}",
