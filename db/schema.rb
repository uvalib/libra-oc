...
ActiveRecord::Schema.define(version: 20170530162116) do
  ...
  create_table "domain_terms", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "model"
    t.string "term"
  ...
  create_table "sufia_features", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
